  ...
  const serviceTiers: ServiceTier[] = [
    {
      ...
      color: "blue",
      price: 499,
      description: "Essential business development services for startups and small businesses",
      estimatedHours: 20,
      features: [
    ...
    },
    {
      ...
      estimatedHours: 150,
      features: [
        "Everything in Giant Star, plus:",
        "Custom Mobile App Development",
        "Enterprise Software Solutions",
        "Full-scale CRM Implementation",
        "AI-Powered Business Analytics",
        "Advanced UI/UX Research & Design",
        ...
        "Dedicated constellation of specialists",
